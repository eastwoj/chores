class ExtraPolicy < ApplicationPolicy
  ...
  def user_is_family_member?
    ...
    # Allow access to adults who belong to the same family as the extra
  ...
  def user_is_admin_or_parent?
    ...
    # More restrictive - only admin or parent can manage extras
  ...
  class Scope < ApplicationPolicy::Scope
    def resolve
      if user.is_a?(Adult)
        # Adults can only see extras from their own family
